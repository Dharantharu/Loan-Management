...
class LoanManager:
    def __init__(self, root):
        ...
        txt_Mp = Entry(Detail_F, font=("Comic Sans MS", 10,),
                       bd=3,textvariable=self.mpay)
        ...
        txt_tp = Entry(Detail_F, font=("Comic Sans MS", 10,),
                       bd=3,textvariable=self.tpay)
        ...
        btn3 = Button(btnFrame, text='Delete', font='arial 12 bold',
                       fg='black', width=9, command=self.delete)
        ...
        btn4 = Button(btnFrame, text='Reset', font='arial 12 bold',
                       fg='black', width=9, command=self.reset)
...
class Login():
    ...
    def login(self):
        ...
        if self.username.get() == "dharan" and self.password.get() == "9360":
